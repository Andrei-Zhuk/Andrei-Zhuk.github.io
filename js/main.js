...
var player, background, currentFrame, weapon, rocks, rock, explosions, explosion,
explosionSound, scoreText, score, bestScore, stateText, gameStartTime,
backgroundTheme, volume, volumeButton, volumeMute, gameIsOn,
startText, timer, doubles, doublePic, doubleTimer, doubleSound, index, tween, aliens, cursors, stage, pause, repair;
score = 0;
volumeMute = {
    pressed: false,
    count: 1
...
function update() {
    ...
    game.physics.arcade.overlap(player.part1, [aliens.scouts.weapon.bullets, aliens.bombers.weapon.bullets,
        aliens.boss.weapon.straight1.bullets, aliens.boss.weapon.straight2.bullets, aliens.boss.weapon.straight3.bullets,
        aliens.boss.weapon.straight4.bullets, aliens.boss.weapon.side1.bullets, aliens.boss.weapon.side2.bullets,
        aliens.boss.weapon.target.bullets], bulletHitPlayer, null, this);
    game.physics.arcade.overlap(player.part2, [aliens.scouts.weapon.bullets, aliens.bombers.weapon.bullets,
        aliens.boss.weapon.straight1.bullets, aliens.boss.weapon.straight2.bullets, aliens.boss.weapon.straight3.bullets,
        aliens.boss.weapon.straight4.bullets, aliens.boss.weapon.side1.bullets, aliens.boss.weapon.side2.bullets,
        aliens.boss.weapon.target.bullets], bulletHitPlayer, null, this);
